...
import '../../../data/controllers/beasiswa_controller.dart';

class BeasiswaTersediaScreen extends StatefulWidget {
  const BeasiswaTersediaScreen({Key? key}) : super(key: key);

  @override
  State<BeasiswaTersediaScreen> createState() => _BeasiswaTersediaScreenState();
}

class _BeasiswaTersediaScreenState extends State<BeasiswaTersediaScreen> {
